...
Version  : 1.6.1
Release  : 65
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/acepack_1.6.1.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/acepack_1.6.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739464083
...
/usr/lib64/R/library/acepack/tests/testthat/test_ace_test.R
